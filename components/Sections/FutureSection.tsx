	...
	return (
		<>
			<section id="future" className="w-full h-[100vh] bg-[#151515] py-10 px-5 md:p-20 relative flex justify-center">
				<h2 className="font-bold tracking-tighter md:left-20 text-3xl md:text-6xl bg-gradient-to-r from-yellow-300 to-blue-400 bg-clip-text text-transparent inline-block absolute">
				&#62;How do I see my future?
				</h2>
				<div className="w-full md:w-6/12 h-full flex items-center">
				<div className="bg-[#F2F2F2] md:w-full md:mx-10 md:h-[300px] w-full h-[400px]">
						<p className="text-[#151515] p-5 md:p-10 italic">
						...
						<div className="bg-[#252525] p-5 w-full justify-center">
				...
				<div className="hidden w-6/12 h-full md:flex items-center justify-center">
					<p className="relative text-[50px] font-bold bg-gradient-to-r from-yellow-300 to-blue-400 bg-clip-text text-transparent flex items-center">
						Where? When? How?

...
const MainHeader = () => {
	return (
		<>
			<header className="w-full h-[650px] bg-black flex">
				<div className="w-6/12 h-full flex items-center justify-center flex-col">
					<div>
				...
				<div className="w-6/12 h-full flex items-center justify-center relative">
					<div className="w-[350px] h-[350px] bg-[#151515] rounded-md z-50 grid grid-cols-3 grid-rows-3 place-items-center">
					...
					<div className="w-[325px] h-[325px] bg-gray-100 rounded-md z-40 absolute left-0 top-0 translate-x-[64%] translate-y-[70%]"></div>
				</div>
			</header>
		</>
	);
